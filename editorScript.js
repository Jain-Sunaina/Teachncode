...
const codeOutputBox = document.getElementById("code-output");
...
function toggleEditors() {
  ...
  userInput.classList.toggle("active", !isHtmlCssJs);

  previewFrame.style.display = isHtmlCssJs ? "block" : "none";
  ...
  codeOutputBox.value = "";
  codeOutputBox.style.display = "none";
}

// Update code output styling to match input box visually
codeOutputBox.style.minHeight = userInput.offsetHeight + "px";
codeOutputBox.style.backgroundColor = "#ffffff";
codeOutputBox.style.color = "#000000";
codeOutputBox.style.border = "1px solid var(--glass-border)";
codeOutputBox.style.borderRadius = "12px";
codeOutputBox.style.marginTop = "15px";
codeOutputBox.style.fontSize = "1rem";
codeOutputBox.style.padding = "15px";
codeOutputBox.style.boxShadow = "inset 0 0 10px rgba(0, 0, 0, 0.1)";
codeOutputBox.style.display = "none";

// The rest of the script remains the same (as you provided)
// ...
...
async function runCode() {
  ...
  if (selectedLang === "html") {
    ...
    codeOutputBox.value = output;
    codeOutputBox.style.display = "block"; // Ensure it's visible
    ...
    try {
      ...
      */
      ...
      codeOutputBox.value = output; // Show in output box
